    ...
    return (
      <DashboardLayout>
        <div className="p-6 space-y-3">
          ...
          <PatientSelector currentId="" organ="heart" />
        </div>
      </DashboardLayout>
    );
  }
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-xs">
            <div className="flex items-center gap-2">
              ...
              <button
                onClick={() => navigate(`/dashboard/doctor/brain?patientId=${patientId || scan.patientId}`)}
            ...
            <PatientSelector currentId={patientId || scan.patientId} organ="heart" />
