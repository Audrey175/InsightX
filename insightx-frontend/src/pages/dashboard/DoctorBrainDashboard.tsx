...
const DoctorBrainDashboard: React.FC = () => {
  ...
  return (
    <DashboardLayout>
      ...
      <div
        ref={reportRef}
        className="p-6 space-y-6 bg-slate-50 min-h-screen rounded-xl"
      >
        {/* REPORT HEADER */}
              ...
              {prediction ? (
                <div className="grid grid-cols-2 gap-x-8 gap-y-3 text-xs border-t pt-4">
                  <div className="space-y-2">
                    ...
                    <p>
                      <span className="text-slate-400">Volume Resolution:</span>{" "}
                      <span className="font-medium">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between border-b border-slate-50 pb-2">
                  <span className="text-xs text-slate-500">Pathology Type</span>
                  <span className="text-xs font-bold text-slate-800">
                    {scan?.injury.type}
                  </span>
                </div>
